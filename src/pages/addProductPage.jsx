    ...
    <div className="flex h-full">
      ...
      <div className="h-screen sm:w-screen sm:px-10 sm:py-5 md:w-screen md:px-10 md:py-5 px-5 py-5 w-screen relative">
        ...
        <div className="flex flex-col gap-2 items-center">
          <h1 className="text-2xl font-win relative pt-2 sm:pt-3 md:pt-3 ">Tambahkan Produk</h1>
        ...
        <form className="flex flex-col gap-3" action="">
          <div className="pt-2">
            ...
            >
              ...
              />
              {image ? (
                <img src={image} className="w-full h-auto md:h-[250px] sm:h-[200px] lg:h-[200px] " alt={fileName} />
              ) : (
        ...
        <div className="flex gap-4 pt-5">
          ...
          <button
            type="submit"
            className="bg-[#bd5d38] px-2 py-2 w-24 mb-4 rounded-md text-white font-win font-light"
          >
            Kembali
          </button>
        </div>
